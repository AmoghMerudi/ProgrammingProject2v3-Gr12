/** 
 * Represents a movie's title and metadata (popularity and revenue)
 * @class MovieTitle
 */
class MovieTitle {
    /**
     * Creates an instance of MovieTitle.
     * @param {number} popularity - Popularity of the movie
    ...
    /**
     * Calculates the size of the text based on popularity.
     * @returns {number} - Text size, with a minimum size of 10
     */
    getTextSize() {
        return Math.max(10, this.popularity / 4.5);
    }
